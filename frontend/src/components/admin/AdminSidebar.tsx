...
export const AdminSidebar = ({ isOpen = false, onClose }: SidebarProps) => {
  const navItems = [
    ...
    { name: 'Study Materials', href: '/admin/materials', icon: 'M5 19a2 2 0 01-2-2V7a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1M5 19h14a2 2 0 002-2v-5a2 2 0 00-2-2H9a2 2 0 00-2 2v5a2 2 0 01-2 2z' },
    ...
    <>
      ...
      <aside className={sidebarClasses}>
        ...
        <div className="p-4 border-t border-slate-800">
          <Link href="/" className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm font-medium text-slate-400 hover:bg-slate-800 hover:text-white transition-colors">
            <svg className="w-5 h-5 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
